...
// Warning: (ae-missing-release-tag) "analyzePath" is part of the package's API, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
export function analyzePath(p: string): IPathInfo;
...
export function concatStringType<
	...
	T3 extends string,
	T4 extends string,
>(t0: T0, t1: T1, t2: T2, t3: T3, t4: T4): `${T0}${T1}${T2}${T3}${T4}`;
...
export function concatStringType<
	...
	T4 extends string,
	T5 extends string,
>(t0: T0, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5): `${T0}${T1}${T2}${T3}${T4}${T5}`;
...
export function concatStringType<
	...
	T5 extends string,
	T6 extends string,
>(t0: T0, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6): `${T0}${T1}${T2}${T3}${T4}${T5}${T6}`;
...
export function concatStringType<
	...
	T6 extends string,
	T7 extends string,
>(t0: T0, t1: T1, t2: T2, t3: T3, t4: T4, t5: T5, t6: T6, t7: T7): `${T0}${T1}${T2}${T3}${T4}${T5}${T6}${T7}`;
...
// Warning: (ae-missing-release-tag) "IPathInfo" is part of the package's API, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
...
// Warning: (ae-missing-release-tag) "PathKind" is part of the package's API, but it is missing a release tag (@alpha, @beta, @public, or @internal)
//
// @public (undocumented)
...
//
// @public (undocumented)
export function prettyFormatError(e: Error, withMessage?: boolean): string;
