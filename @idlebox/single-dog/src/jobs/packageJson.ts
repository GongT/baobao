import { defaultJsonFormatConfig, getFormatInfo, insertKeyAlphabet, loadJsonFile, reformatJson, writeJsonFile } from '@idlebox/node-json-edit';
import { getPackageManager, resolveLatestVersionOnNpm } from '@idlebox/package-manager';
...
export async function updatePackageJson(mode: IRunMode) {
	...
	if (mode.libMode) {
		devPackagesCopy.push('@idlebox/export-all-in-one');
	}
