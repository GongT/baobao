...
Node.js 平台工具函数库，提供子进程管理、流处理、文件系统操作、路径解析、环境变量管理、进程生命周期控制（全局退出处理器/信号处理）、加密哈希、调试工具和终端日志等功能。
...
<!-- File: child_process/disposable.process.md -->
...
<!-- File: child_process/lateError.md -->
...
<!-- File: environment/findBinary.md -->
...
<!-- File: environment/getEnvironment.md -->
...
<!-- File: environment/pathEnvironment.md -->
...
<!-- File: events/dumpEventEmitter.md -->
...
<!-- File: lifecycle/custom-error-handlers.md -->
...
<!-- File: lifecycle/process-shutdown.md -->
...
<!-- File: lifecycle/workingDirectory.md -->
...
<!-- File: path-resolve/findPackageRoot.md -->
...
<!-- File: path-resolve/lrelative.md -->
...
<!-- File: path-resolve/nodeResolvePathArray.md -->
...
<!-- File: path-resolve/resolvePath.md -->
...
<!-- File: stream/blackHoleStream.md -->
...
<!-- File: stream/collectingStream.md -->
...
<!-- File: stream/disposableStream.md -->
...
此为 TypeScript 配置文件，不包含可文档化的公开 API。配置了 Node.js 环境并排除 `*.generator.ts` 和 `*.test.ts` 文件。
