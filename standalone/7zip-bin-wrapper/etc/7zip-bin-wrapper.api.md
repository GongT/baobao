...
// Warning: (ae-forgotten-export) The symbol "FilterStream" needs to be exported by the entry point index.d.ts
...
// Warning: (ae-forgotten-export) The symbol "ProgressStream" needs to be exported by the entry point index.d.ts
